...
(async (): Promise<void> => {
  ...
  const params: CreateCollectionParams = {
    ...
    icon_url: 'https://gateway.pinata.cloud/ipfs/QmY4S5ZkB6zQvK15irEQY7LGrMgMcPNMjypM2UEYodyotW',
    metadata_api_url: 'https://gateway.pinata.cloud/ipfs/Qmc4mW5amNAqEwKJfgyjtA98U9bcic5CQnG5qwUWMjmx9b',
    collection_image_url: 'https://gateway.pinata.cloud/ipfs/QmY4S5ZkB6zQvK15irEQY7LGrMgMcPNMjypM2UEYodyotW',
